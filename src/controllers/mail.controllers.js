    ...
    sendEmailCoti: (jsonData) => {
        const emailContent = `
            <div style="max-width: 600px; margin: auto; font-family: Arial, sans-serif; background-color: #ffffff; padding: 20px; border: 1px solid #dddddd;">
              ...
              <p style="color: #083180;">Tienes pendiente en el market la cotización del producto ${
                  jsonData.type
              }.</p>
              <div style="margin-top: 20px; color: #083180;">
                <p><strong>Datos de cliente</strong></p>
                <p><strong>Nombre:</strong> ${jsonData.client.nombre}</p>
                <p><strong>Email:</strong> ${jsonData.client.email}</p>
                <p><strong>Teléfono:</strong> ${jsonData.client.telefono}</p>
                <br>
                <p><strong>Datos de producto</strong></p>
                ${Object.entries(jsonData.description)
                    .map(([key, value]) => {
    ...
    sendEmailCotiClient: (jsonData) => {
      const emailContent = `
          <div style="max-width: 600px; margin: auto; font-family: Arial, sans-serif; background-color: #ffffff; padding: 20px; border: 1px solid #dddddd;">
            ...
            <p style="color: #083180;">Su producto está siendo cotizado ${
                jsonData.type
            }.</p>
            <div style="margin-top: 20px; color: #083180;">
      ...
      const emailOptions = {
          recipient_email: jsonData.client.email,
          inner_mail: emailContent,
